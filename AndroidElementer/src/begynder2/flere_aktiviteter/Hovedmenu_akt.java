package begynder2.flere_aktiviteter;
...
public class Hovedmenu_akt extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//enKnap = (Button) findViewById(R.id.spilKnap);
		//enAndenKnap = (Button) findViewById(R.id.indstillingerKnap);
		//enTredjeKnap = (Button) findViewById(R.id.hjaelpKnap);
