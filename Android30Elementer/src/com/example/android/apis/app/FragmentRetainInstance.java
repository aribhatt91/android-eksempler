 ...
 */
public class FragmentRetainInstance extends LogFragmentActivity {
  /**
  ...
  @Override
     ...
     */
    public static class UiFragment extends LogFragment {
    /**
   * Denne klassevariabel vil tælle antallet af objekter (instanser af klassen)
   */
  static int instansNummer = 0;
     ...
     */
    public static class RetainedFragment extends LogFragment {
    /**
   * Denne klassevariabel vil tælle antallet af objekter (instanser af klassen)
   */
  static int instansNummer = 0;
