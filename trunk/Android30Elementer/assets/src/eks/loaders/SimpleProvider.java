  ...
  public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
    ...
    switch (mUriMatcher.match(uri)) {
      ...
      case MAIN_ID:
        ...
        String[] nyselectionArgs = new String[selectionArgs.length + 1];
        System.arraycopy(selectionArgs, 0, nyselectionArgs, 0, selectionArgs.length);
  ...
  public int delete(Uri uri, String where, String[] whereArgs) {
    ...
    // particular note ID.
      case MAIN_ID:
        ...
        throw new RuntimeException("Ikke implementeret");
        /*
